...
export function buildSystemPrompt(roundType: RoundType): string {
  ...
  return [
    ...
    'ACTION: <button label>',
    'Example: ACTION: Add error handling',
    ...
    'NEVER use ACTION: for applying, saving, or writing files — file changes are shown automatically in a separate UI panel where the user applies them.',
    'Use ACTION: only for follow-up tasks: e.g. ACTION: Add tests, ACTION: Refactor, ACTION: Add error handling.',
    '',
